...
const fiatCurrenciesList = [
    ...
    ["EUR", "€", "Euro", 2],
    ["AED", "AED", "United Arab Emirates Dirham", 2],
    ["AFN", "Af", "Afghan Afghani", 0],
    ["ALL", "ALL", "Albanian Lek", 0],
    ["AMD", "AMD", "Armenian Dram", 0],
    ["ARS", "AR$", "Argentine Peso", 2],
    ["AUD", "AU$", "Australian Dollar", 2],
    ["AZN", "man.", "Azerbaijani Manat", 2],
