...
export default class AddressesService {
    ...
    static async createNewExternalAddress(label) {
        try {
            ...
            return await createAddressBySchemeAndIncrementValue(scheme, label || Address.labelAutogenerated);
        } catch (e) {
            improveAndRethrow(e, "createNewExternalAddress");
        }
    }
    ...
    static async createNewAddressForInvoice(label = "Autogenerated") {
        try {
            ...
            improveAndRethrow(e, "createNewAddressForInvoice");
        }
    }
