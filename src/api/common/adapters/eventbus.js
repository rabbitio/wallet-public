...
export const BALANCE_CHANGED_EXTERNALLY_EVENT = "balanceChangedExternallyEvent";
...
export const INCREASE_FEE_IS_FINISHED_EVENT = "increaseFeeIsFinishedEvent";
export const SWAP_CREATED_EVENT = "swapCreatedEventEvent";
export const SWAP_TX_PUSHED_EVENT = "swapTxPushedEvent";
